...
func (u Uint128) Bytes() []byte {
	...
	u.PutBytes(balanceBytes)
	return balanceBytes
}

func (u Uint128) BytesBE() []byte {
	balanceBytes := make([]byte, 16)
	u.PutBytesBE(balanceBytes)
	return balanceBytes
}

func Read(r io.Reader) Uint128 {
	balanceBytes := make([]byte, 16)
	io.ReadFull(r, balanceBytes)
	return FromBytes(balanceBytes)
}

func ReadBE(r io.Reader) Uint128 {
	balanceBytes := make([]byte, 16)
	io.ReadFull(r, balanceBytes)
	return FromBytesBE(balanceBytes)
}
